...
class MaskFormerParsingLSJDatasetMapper:
    ...
    This dataset mapper only support multi human parsing currently.
    """
    ...
    def __init__(
        ...
        *,
        ...
        logging.getLogger(__name__).info(
            "[MaskFormerParsingInstanceLSJDatasetMapper] Full TransformGens used in training: {}".format(str(self.tfm_gens))
        )
