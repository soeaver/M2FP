...
__all__ = ["MaskFormerSingleHumanTestDatasetMapper"]


class MaskFormerSingleHumanTestDatasetMapper:
    @configurable
    def __init__(
        self,
        is_train,
        *,
        ...
        logger.info(
            f"[MaskFormerSingleHumanTestDatasetMapper] Augmentations used in {mode}: self.implemented center_to_target_size"
        )
